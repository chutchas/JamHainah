...
const ALLOWED = [
  ...
  // ทั้งรอบเช้าและปุ่มยิงซ้ำในหน้าห้องทำงาน ต้องเดินผ่านไฟล์นี้เท่านั้น
 ...
 */
/**
 * ปุ่มยิงซ้ำในหน้าห้องทำงาน ต้องไม่ยิงเอง
 *
 ...
 */
test('เส้นทางห้องทำงานต้องยิงผ่านเครื่องยนต์เดิมเท่านั้น', () => {
  const root = path.resolve(import.meta.dirname, '..');
